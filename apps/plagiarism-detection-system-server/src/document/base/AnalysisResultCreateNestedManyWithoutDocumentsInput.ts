...
@InputType()
class AnalysisResultCreateNestedManyWithoutDocumentsInput {
...
export { AnalysisResultCreateNestedManyWithoutDocumentsInput as AnalysisResultCreateNestedManyWithoutDocumentsInput };
